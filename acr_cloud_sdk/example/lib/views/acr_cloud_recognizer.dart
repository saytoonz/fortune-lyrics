...
class ACRCloudPage extends StatefulHookWidget {
  final SharedPreferences? pref;
  ACRCloudPage({this.pref});
  @override
  _ACRCloudPageState createState() => _ACRCloudPageState();
}

class _ACRCloudPageState extends State<ACRCloudPage>
